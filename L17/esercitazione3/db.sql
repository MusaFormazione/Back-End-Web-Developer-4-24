...
-- Dump della struttura di tabella dbgpbrymyfcctt.users
...
-- Dump dei dati della tabella dbgpbrymyfcctt.users: ~2 rows (circa)
...
-- Dump della struttura di tabella dbgpbrymyfcctt.products
...
-- Dump dei dati della tabella dbgpbrymyfcctt.products: ~9 rows (circa)
...
-- Dump della struttura di tabella dbgpbrymyfcctt.orders
...
-- Dump dei dati della tabella dbgpbrymyfcctt.orders: ~3 rows (circa)
...
-- Dump della struttura di tabella dbgpbrymyfcctt.order_items
...
-- Dump dei dati della tabella dbgpbrymyfcctt.order_items: ~7 rows (circa)
